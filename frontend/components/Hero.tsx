  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="hidden lg:flex absolute left-10 xl:left-16 top-1/2 -translate-y-1/2 flex-col gap-6 z-20">
        {[
          ...
          },
          {
            ...
            href: "https://www.geeksforgeeks.org/profile/shreyam91",
            label: "GeeksForGeeks",
          },
        ].map((social, i) => (
          <motion.a
      ...
      <div className="relative z-10 max-w-5xl w-full px-6 md:px-12 lg:px-24 flex flex-col items-center text-center mt-12">
        ...
        >
          {(heroData.headline || "Every great system begins with a journey.")
            .split(" ")
            .map((word: string, i: number) => (
              <React.Fragment key={i}>
                {word.toLowerCase().includes("journey") ? (
                  <span className="font-serif italic text-blue-600 block sm:inline mt-2 sm:mt-0">
                    {word}
                  </span>
                ) : (
        ...
        >
          {heroData.shortBio ||
            heroData.tagline ||
            "Exploring systems, interfaces, and digital experiences."}
        </motion.p>
        ...
        >
          <a
            href="#projects"
            className="group relative px-8 py-3 bg-[#1a1a1a] dark:bg-white rounded-full overflow-hidden shadow-lg transition-transform hover:-translate-y-1"
          >
          ...
          <a
            href="/shreyam_kanaujiya_Fullstack_developer.pdf"
            download
            className="group relative px-8 py-3 bg-white/50 dark:bg-[#111111]/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800 rounded-full overflow-hidden shadow-sm hover:shadow-md transition-all hover:-translate-y-1"
          >
