...
const certifications = [
  {
    ...
    theme: "bg-green-50/50 dark:bg-green-900/10 border-green-100 dark:border-green-900/30 hover:border-green-300 dark:hover:border-green-700/50",
  ...
  },
  {
    ...
    theme: "bg-blue-50/50 dark:bg-blue-900/10 border-blue-100 dark:border-blue-900/30 hover:border-blue-300 dark:hover:border-blue-700/50",
  ...
  },
  {
    ...
    theme: "bg-orange-50/50 dark:bg-orange-900/10 border-orange-100 dark:border-orange-900/30 hover:border-orange-300 dark:hover:border-orange-700/50",
...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="relative w-full py-18 bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          <span className="text-xs font-mono text-gray-500 uppercase tracking-widest mb-2 block">06</span>
          <h2 className="text-3xl md:text-5xl font-light text-[#1a1a1a] dark:text-white mb-4">
            Professional <span className="font-serif italic text-gray-500">Credentials</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {certifications.map((cert, i) => (
            ...
            >
              ...
              <div className={`relative z-10 w-12 h-12 rounded-xl flex items-center justify-center shadow-sm mb-6 transition-transform group-hover:scale-110 group-hover:rotate-3 ${cert.iconTheme}`}>
                <FiAward size={24} />
              </div>
              <h3 className="relative z-10 text-xl font-medium text-[#1a1a1a] dark:text-white mb-2">{cert.title}</h3>
              <p className="relative z-10 text-sm font-mono text-gray-500 dark:text-gray-400 mb-4">{cert.issuer} • {cert.date}</p>
              
              <div className="relative z-10 flex flex-wrap gap-2 mt-auto pt-6">
                {cert.skills.map((skill) => (
                  <span key={skill} className="px-3 py-1 bg-white/60 dark:bg-black/60 backdrop-blur-sm border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 text-[10px] uppercase tracking-wider rounded-full group-hover:border-gray-300 dark:group-hover:border-gray-700 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
          ...
          >
            ...
            >
              ...
              <div className="p-8 md:p-12">
                ...
                <h2 className="text-2xl md:text-3xl font-medium text-[#1a1a1a] mb-2">{selectedCert.title}</h2>
