...
export const contentService = {
  ...
  getMachineCodingQuestions: (page = 1, limit = 100) => getList('/machine-coding', page, limit),
  getSystemDesignQuestions: (page = 1, limit = 100) => getList('/system-design', page, limit),
  getBlogs: (page = 1, limit = 100) => getList('/blogs', page, limit),
  getVideos: (page = 1, limit = 100) => getList('/videos', page, limit),
  getPlacementPrep: (page = 1, limit = 100) => getList('/placement-prep', page, limit),
  getPlacementPrepTopics: (page = 1, limit = 100) => getList('/placement-prep', page, limit),
